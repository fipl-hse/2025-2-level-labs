...
print(count_substring_occurrences("banana", "ana"))# → 1
print(count_substring_occurrences("aaaa", "aa"))# → 2
...
print(generate_hashtag(" Hello there thanks for trying my quiz"))# → "#HelloThereThanksForTryingMyQuiz"
