...
from lab_1_keywords_tfidf.main import clean_and_tokenize, get_top_n, calculate_frequencies, calculate_chi_values, calculate_expected_frequency, calculate_tf, calculate_tfidf, remove_stop_words
...
def main() -> None:
    ...
    top_words = get_top_n(tfidf_frequencies)
