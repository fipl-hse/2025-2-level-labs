...
def add_letter(word: str, alphabet: list[str]) -> list[str]:
    ...
    Args:
        word (str): The input incorrect word.
        alphabet (list[str]): The alphabet with russian letters.
...
def generate_candidates(word: str, language: str = "ru") -> list[str] | None:
    """
    ...
    Args:
        ...
        language (str): Language for candidates creation ("ru" or "en").
...
def propose_candidates(word: str) -> tuple[str, ...] | None:
    """
...
def calculate_frequency_distance(word: str, frequencies: dict) -> dict[str, float] | None:
    """
