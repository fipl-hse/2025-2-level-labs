...
def main() -> None:
    ...
    print("N-gram building dict return: ", n_gram_processor.build())
    ...
    print("GreedyTextGenerator for 'Potter', 51: ", test_sequense_greedy)
    ...
    print("BeamSearchTextGenerator for 'Potter', 51: ", test_sequense_beam)
